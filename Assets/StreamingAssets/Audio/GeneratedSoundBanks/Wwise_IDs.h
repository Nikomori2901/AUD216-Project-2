...
namespace AK
{
    namespace EVENTS
    {
        ...
        static const AkUniqueID PLAY_FRIDGE = 2316918641U;
        static const AkUniqueID PLAY_FURNACE_FIRE_CRACKLES = 1171153354U;
        static const AkUniqueID PLAY_FURNACE_RUMBLES = 1660495545U;
        static const AkUniqueID PLAY_GRAMOPHONE = 930871454U;
        static const AkUniqueID PLAY_GRANDFATHER_CLOCK_TICKING = 3529309445U;
        static const AkUniqueID PLAY_GREENHOUSE_AMBIENCE_AND_MUSIC_BLEND_CONTAINER = 4139471422U;
        static const AkUniqueID PLAY_GUESTHOUSE_CLOCK = 2791222881U;
        static const AkUniqueID PLAY_INSIDE_AMBIENCE_AND_MUSIC_BLEND_CONTAINER = 1551283559U;
        ...
        static const AkUniqueID PLAY_WATER_DRIP_SEQUENCE = 1486568025U;
    ...
    namespace STATES
    {
        ...
        namespace UPSTAIRS_DOWNSTAIRS
        {
            static const AkUniqueID GROUP = 1978863953U;

            namespace STATE
            {
                static const AkUniqueID DOWNSTAIRS = 4106209011U;
                static const AkUniqueID NONE = 748895195U;
                static const AkUniqueID UPSTAIRS = 769052060U;
            } // namespace STATE
        } // namespace UPSTAIRS_DOWNSTAIRS
